    ...
    <div className="flex h-screen bg-linear-to-r from-indigo-400 via-purple-500 to-pink-500">
      ...
      >
        ...
        <div
          ...
          className="mt-4 flex items-center gap-2 p-2 cursor-pointer bg-white/90 rounded"
        >
          <FiLogOut size={20} />
      ...
      >
        {selectedUser && (
          <div className="md:hidden fixed w-full flex items-center p-2 bg-purple-500 text-white shadow-md">
            <button
